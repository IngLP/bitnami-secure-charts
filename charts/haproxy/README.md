...
```console
helm install my-release oci://REGISTRY_NAME/REPOSITORY_NAME/haproxy --set "global.imagePullSecrets[0]=SECRET_NAME" -n NAMESPACE
```
...
| `global.defaultFips`                                  | Default value for the FIPS configuration (allowed values: '', restricted, relaxed, off). Can be overridden by the 'fips' object                                                                                                                                                                                                                                     | `off`   |
